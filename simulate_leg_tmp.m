...
eshat = cos(ths)*ihat + sin(ths)*jhat;
...
%FOOT
r_heela = rC + l_heela*e1hat;
rH = rE + l_GH*e3hat; %two havles of the same foot
rI = rE-l_IG*e3hat; %second half MAKE NEGATIVE TO FLIP DIRECTION OF VECTOR, heel position
r_m5 = rE + c5*e3hat;
