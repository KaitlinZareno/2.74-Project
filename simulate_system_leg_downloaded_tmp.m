function simulate_system_leg()
    ...
    l_O_m1=0.032;           l_B_m2=0.0344;          l_anklerest = 0.08;
    ...
    z0 = [0; .17; -pi/4; pi/2; 0; 0; 0; 0; 0; 0; 0; 0]; %moves with x velocity!
...
function tau = control_law(t,z,p)
    ...
    K_x = 250; % Spring stiffness X
    K_y = 250; % Spring stiffness Y
    D_x = 1;  % Damping X
    D_y = 1;  % Damping Y
